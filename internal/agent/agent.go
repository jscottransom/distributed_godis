...
func (a *Agent) setupKVStore() error {
	var err error
	a.kvstore, err = kvstore.NewKVstore(
		a.Config.DataDir,
		a.Config.StoreName,
	)
	return err
...
func (a *Agent) setupMembership() error {
	...
	a.replicator = &kvstore.Replicator{
		DialOptions: opts,
		LocalServer: client,
	}
...
func (a *Agent) Shutdown() error {
	...
	shutdown := []func() error{
		...
		func() error {
			a.kvstore.Remove(a.Config.DataDir)
			return nil
		},
	}
